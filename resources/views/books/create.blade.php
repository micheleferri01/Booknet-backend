...
<div class="container pt-4 d-flex justify-content-center align-items-center">
    <div class="row justify-content-center w-100">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Nuovo libro') }}</div>
                ...
                <div class="card-body">
                    <form action="{{route('books.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id='title' name='title' class="form-control @error('title') is-invalid @enderror" required value="{{ old('title') }}" autofocus>
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-6">
                                <input type="number" id='Publication_year' name='Publication_year' class="form-control @error('Publication_year') is-invalid @enderror" required value="{{ old('Publication_year') }}">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-6">
                                <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" required value="{{old('price')}}" step="0.01" min='0.01'>
                                @error('price')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
