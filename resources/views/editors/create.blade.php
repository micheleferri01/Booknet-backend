...
<div class="container pt-4 d-flex justify-content-center align-items-center">
    <div class="row justify-content-center w-100">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Nuova casa editrice') }}</div>

                <div class="card-body">
                    <form action="{{route('editors.store')}}" method="post">
                        @csrf
                        <div class="mb-4 row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Nome casa editrice</label>
                            <div class="col-md-6">
                        ...
                        <div class="mb-4 row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a href="{{route('editors.index')}}" class="btn btn-secondary">{{ __('Annulla')}}</a>
                            </div>
                        </div>
                    </form>
